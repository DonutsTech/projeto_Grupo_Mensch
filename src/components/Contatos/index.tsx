        ...
        <div className={Style.contatos__content__redes}>
          ...
          <div className={Style.contatos__content__redes__dados}>
            ...
            <div className={classNames({
              ...
              <Link href={'https://wa.me/553499665871/?text=Olá venho do seu site e quero falar com você!'} target='_blank' rel='noopener noreferrer'>
                <Image src={wpp} alt='Email' height={48} />
              </Link>
              <p>34) 9.9666-5871</p>
            </div>
            ...
            <div className={classNames({
              ...
              <Link href={'https://www.instagram.com/grupo.mensch/'} target='_blank' rel='noopener noreferrer'>
                <Image src={insta} alt='Email' height={48} />
              </Link>
              <p>@grupo.mensch</p>
            </div>
            ...
            <div className={classNames({
              ...
              <Link href={'https://www.facebook.com/profile.php?id=100091541775500&locale=pt_BR'} target='_blank' rel='noopener noreferrer'>
                <Image src={face} alt='Email' height={48} />
              </Link>
              <p>@grupo.mensch</p>
            </div>
